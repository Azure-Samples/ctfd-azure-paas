...
module cacheSecret 'keyvaultsecret.bicep' = {
  ...
  params: {
    ...
    secretValue: 'mysql+pymysql://${administratorLogin}@${mariaServerName}.mariadb.database.azure.com:${administratorLoginPassword}@${mariaServerName}.mariadb.database.azure.com/ctfd'
  }
}
